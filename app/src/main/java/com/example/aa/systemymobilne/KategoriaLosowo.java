...
public class KategoriaLosowo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kategoria_losowo);
    ...
    {
        danePomoc.zapiszIlosPunktow("PUNKTYLOSOWO", punkty);
        startActivity(new Intent(KategoriaLosowo.this, KategoriaLosowoRezultat.class));
        finish();
    }
