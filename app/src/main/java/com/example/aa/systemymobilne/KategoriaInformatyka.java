...
public class KategoriaInformatyka extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kategoria_informatyka);
    ...
    {
        danePomoc.zapiszIlosPunktow("PUNKTY", punkty);
        startActivity(new Intent(KategoriaInformatyka.this, KategoriaInformatykaRezultat.class));
        finish();
    }
    ...
    private void updateTaskList() {
        if(kursor != null && kursor.moveToFirst()) {
            do {
                ...
                if(kategoria.equals("INFORMATYKA"))
                {
