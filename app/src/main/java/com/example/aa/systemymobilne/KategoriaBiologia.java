...
public class KategoriaBiologia extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kategoria_biologia);
        znajdzWidoki();
    ...
    public void rezultat() {
        danePomoc.zapiszIlosPunktow("PUNKTYBIOLOGIA", punkty);
        startActivity(new Intent(KategoriaBiologia.this, KategoriaBiologiaRezultat.class));
        finish();
    }
